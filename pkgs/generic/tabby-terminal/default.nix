...
let
  tabby = rec {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-g9Njii6CkOJolTTQG5cdeFKapgpjnnyOqHQFsqOQwp4=";
      leaveDotGit = true;
    };
    ...
    electronHeaders = fetchurl {
      ...
      hash = "sha256-qkD8GYznO88qZvnDPbkmjIRrAQaJFQCzVuD/0ik3YF0=";
    };

    electronHeadersSHA = fetchurl {
      url = "https://www.electronjs.org/headers/v${electronPackage.version}/SHASUMS256.txt";
      hash = "sha256-8BxStWZtflQ0pFA/TY3lLOIlbZcGcQ0vYVd7SDyoBkY=";
    };
